...
function _setCommonAttrValues(params) {
    ...
    const hiresImage = variationMaster.getImage('hi-res', attr, attrValue);
    ...
    const processedValue = {
        ...
        hiresImage: JSON.stringify({
            url: hiresImage.getURL().toString(),
            title: hiresImage.getTitle(),
            alt: hiresImage.getAlt(),
...
function _getHasSwatch (attrAttributeId) {
    return false;
    /* Commenting out the return below as we don't have swatch images for the products on this site */
